...
| Responsive styles | ● | ● | Managed through `theme` in **theme-ui**, and explicitly in `styles` (i.e. `config.responsiveBreakpoints`) in **uinix-ui**.
| Typography styles | ● | ● | Managed through `theme` in **theme-ui**, and explicitly in `styles` in **uinix-ui**.
